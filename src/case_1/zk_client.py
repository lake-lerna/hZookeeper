...
l = util.createlogger('ZKTest', logging.INFO)
...
class ZKTest(HDaemonRepSrv):
    ...
    def writer(self):
        """
        Function that will be called in case of 'startwriter' signal
        """
    ...
    def reader(self, j):
        """
        Function that will be called in case of 'startreader' signal
        """
